...
module.exports = {
	...
	createANewCharacter: function() {
		var names = ["Robot55","Benjy","Joe","Jack","Jill","Daz","Amotz","Keren","Mehmet","Jessica","Bwian","Doctor","Scott","Bambino","Eliran","Krishna","Jesus","Pope Francis","Jubei","Benedict","Corwin","Marquiz","Johnny","John","Indianna","Stevie", "Hans", "Minnie", "James", "Stringer", "Jimmy", "Avon","Frank","Nikki","Ziggy","Elric","Omar","Omar","John","Woody","Elric","Elvira","Dale","Agent"]
		...
		var midTitles = ["Von","Ben","Eben","De","Du","Zee","Uber","Di","of","","","","","","","","","","","the first of his name"]
		
		var aNewCharacter = {"alive":true,"level":1}
		aNewCharacter.name = names[roll.roll("d"+names.length).result-1]+" "+midTitles[roll.roll("d"+midTitles.length).result-1]+" "+surNames[roll.roll("d"+surNames.length).result-1];
