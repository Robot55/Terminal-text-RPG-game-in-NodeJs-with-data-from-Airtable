...
var app = new Vue({
  ...
  methods: {
	...
	getClasses : function (callback) {
		...
		jQuery.getJSON( "http://www.dnd5eapi.co/api/"+endpointName, function( json ) {
			...
			app.hydrateObject(app.api[endpointName][i],function(hydratedObject){
					...
					if(i==0) app.ui.selectedClass = hydratedObject;
				});
	...
	nextClass : function() {
		var index = app.api.classes.indexOf(app.ui.selectedClass)+1 % app.api.classes.length;
		app.ui.selectedClass = app.api.classes[index]
	},
	prevClass : function() {
		var index = app.api.classes.indexOf(app.ui.selectedClass)-1 % app.api.classes.length;
		app.ui.selectedClass = app.api.classes[index]
...
$( document ).ready(function() {
    ...
    app.getAbilities (app.getRaces(app.getClasses));
